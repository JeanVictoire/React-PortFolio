...
const Skills = () => {
  return (
    <div name='skills' className='w-full h-screen bg-[#0a192f] text-gray-300 pb-20 content-divv'>
      {/* Container */}
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full pb-20'>
          <div>
              <p className='text-4xl font-bold inline border-b-4 border-[#01D5A2] '>Skills</p>
